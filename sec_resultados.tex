...
Para lograr comprender mejor las propiedades fotofísicas en solución, se
...
4),\todo{poner con comando \texttt{reactant}} donde el fragmento de aminoácido
no causa ninguna obstrucción estérica y los ángulos de torsión diédricos están
cerca de \qty{55}{\degree} (ver ESI).\todo{Conseguir ESI} Además, se calcularon
...
4,\todo{poner con comando \texttt{reactant}} que no tienen obstrucción estérica,
