...
% El efecto supresor de la luminiscencia del triptófano es un fenómeno en el cual la emisión de luz de este aminoácido se ve inhibida o apagada debido a la interacción con otras especies supresoras presentes en su entorno. El triptófano es conocido por ser un fluoróforo natural y su emisión de luz se produce principalmente a través del proceso de fosforescencia, que es una forma de luminiscencia de larga duración. Sin embargo, este proceso puede ser modulado o suprimido por la presencia de compuestos supresores. Existen diferentes mecanismos por los cuales se produce el efecto supresor de la luminiscencia del triptófano, y algunos de los más comunes son: Transferencia de energía por resonancia (RET, por sus siglas en inglés): En este mecanismo, la energía de excitación del triptófano es transferida a una molécula cercana a través de la superposición de las órbitas electrónicas. Esta molécula receptora puede ser un cromóforo cercano, un agente químico o una especie metálica. La transferencia de energía provoca una disminución en la intensidad de la emisión luminiscente del triptófano. Transferencia de carga: En este mecanismo, el triptófano se encuentra en un ambiente químico o electroquímico donde puede donar o aceptar electrones. Cuando se produce una transferencia de carga del triptófano a una especie química receptora, se produce una disminución en la emisión de luz. Esto puede ocurrir, por ejemplo, en presencia de iones metálicos como el cobre o el hierro. Quenching estático: En este caso, el quencheo ocurre debido a la formación de un complejo o una asociación entre el triptófano y la especie quencheadora. Esta interacción puede alterar la estructura electrónica del triptófano y disminuir su capacidad para emitir luz. 
% Es importante destacar que el efecto quencheador de la luminiscencia del triptófano puede ser utilizado en diversos campos, como la bioquímica y la biología molecular, para investigar interacciones moleculares y procesos bioquímicos. Por ejemplo, se ha utilizado el quencheo del triptófano como una herramienta para estudiar la unión de ligandos a proteínas, la formación de estructuras secundarias en péptidos y la dinámica de plegamiento de proteínas. En resumen, el efecto quencheador de la luminiscencia del triptófano se refiere a la disminución o supresión de la emisión de luz de este aminoácido debido a la interacción con otras especies quencheadoras. Los mecanismos involucrados en este proceso incluyen la transferencia de energía por resonancia, la transferencia de carga y el quenching estático. El estudio de este fenómeno proporciona información valiosa sobre interacciones moleculares y procesos bioquímicos. En el presente proyecto se sonosintetizarán cuatro compuestos luminiscentes de Boro derivados de aminoácidos (triptófano, fenilamina, tirosina y glicina), su caracterización química-fotofísica y estudios por modelado molecular. 
...
\subsubsection{Síntesis}\todo{Detallar}
...
\subsubsection{Determinación de propiedades ópticas}\todo{Detallar}
...
\subsubsection{Determinación de citotoxicidad}\todo{Verificar!}
Se determinará la citotoxicidad de los compuestos \textbf{1-4} en la línea celular de melanoma murino \emph{B16F10} (ATCC® CCL-6475™) derivado de ratón C57BL/6J.\todo{verificar si este es el melanoma con el que se hará el estudio}
...
\paragraph{Optimización geométrica}\todo{Verificar!}
...
\paragraph{Obtención de espectro de emisión}\todo{Verificar}
Se obtendrá el espectro de emisión de los compuestos \textbf{1-4} por medio de cálculos \gls{TDDFT} con el funcional ωB97X-V\todo{Verificar si es plausible usar \scan{} para calculos TDDFT.} y con el fin de aproximarse al límite CBS, se requiere de aumentación con funciones difusas dobles, por lo que se usará el conjunto de fuinciones base \emph{def2-TZVPD} o \emph{def2-QZVPPD} si es necesario obtener estados de Rydberg
