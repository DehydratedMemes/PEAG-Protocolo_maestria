...
\subsection{Costos}
Se estima un costo aproximado de \num{70000.00} MXN para la realización de esta investigación, el cual se desglosa en las \cref{tbl:tbl:costos-react,tbl:costos-caract}.
...
\begin{longtblr}[
        ...
        colspec={X[2,c,m] X[1,c,m] X[1.5,c,m] X[1.5,c,m,si={table-format=4.2}]},rowhead=1
    }
    \toprule
...
\begin{longtblr}[
    ...
    entry = {Costos de los metodos de cacterización.}
        ...
        colspec={X[2,c,m] X[1,c,m] X[1.5,c,m,si={table-format=4.2}] X[1.5,c,m,si={table-format=4.2}]},rowhead=1
    }
    \toprule
